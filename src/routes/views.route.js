...
// http://localhost:PORT/
router
  .get("/", handleResponses, vControl.login)
  .get("/register", handleResponses, vControl.register)
  .get("/products", handleResponses, vControl.products)
  .get("/products/:pid", handleResponses, vControl.productById)
  .get("/cart", handleResponses, vControl.cart)
  .get("/realTimeProducts", handleResponses, vControl.realTimeProducts)
  .get("/chat", handleResponses,vControl.chat)
  .get('/user', handleResponses, vControl.user);
